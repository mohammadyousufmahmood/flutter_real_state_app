/// Flag SVG markup used by the language picker.
///
/// Inlined so flags still render without a full restart after adding assets.
/// Only two flags are needed: the UK flag for English, and the Afghan flag
/// for both Pashto and Dari (both are official languages of Afghanistan).
abstract final class LanguageFlagSvgs {
  static const String gb = r'''
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="flag-icons-af" viewBox="0 0 512 512">
  ...
  <g fill="#fff" fill-rule="evenodd" stroke="#bd6b00" stroke-width=".5" transform="translate(2.2 86.8)scale(.84611)">
    ...
    <use href="#af-a" xlink:href="#af-a" width="100%" height="100%" x="-600" transform="scale(-1 1)"/>
    <g stroke="none">
